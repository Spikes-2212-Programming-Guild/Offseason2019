...
public class Drivetrain extends TankDrivetrain {
    ...
    public static final Namespace ORIENT_PID = NAMESPACE.addChild("Forward PID");

    public static final Supplier<Double> ORIENT_KP = ORIENT_PID.addConstantDouble("KP", 0.5);
    public static final Supplier<Double> ORIENT_KI = ORIENT_PID.addConstantDouble("KI", 0.0);
    public static final Supplier<Double> ORIENT_KD = ORIENT_PID.addConstantDouble("KD", 0.0);
    public static final Supplier<Double> ORIENT_WAIT_TIME = ORIENT_PID.addConstantDouble("Wait Time", 0.1);
    public static final Supplier<Double> ORIENT_TOLERANCE = ORIENT_PID.addConstantDouble("Tolerance", 1.0);
